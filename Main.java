...
// This class prints the welcome statment and greeds thw players though I don't know how to controle when to display this message. (theo)

   /// Q ESTIONS TIP SUPPORT: WHAT DOSE THE ARG MEAN WHEN IN A PARENTHESES DELEATE THIS ONE YOU ANSWER ON TEXT OR CALL
   class game_message(String[] arg) {
      System.out.println("Welcome to the game named FIND MY WAY TO FREEDOM, a game that requires you to think outside of the box. Every choice you make could matter. There is no room for mistakes. The survival of your crew is in your hands. Can you prove you are the Champion to save your people?")

      System.out.println("The earth has been destroyed by the governments around the world. The 7 most powerful forces came together and fought the most devastating war. According to estimates, nearly 7.5 billion people have been wiped out from the face of the planet. The other 1 billion were annihilated from poisoning. The major forces that contributed to the war were China, Israel, the United States, Russia, Iran, India, and North Korea. This war could be described as World War III. It truly has been unleashed on the earth and has killed over 8 billion people. You and your friend happen to find a mysterious way to escape this planet to find freedom somewhere else. Earth is not the same as it was before.")
