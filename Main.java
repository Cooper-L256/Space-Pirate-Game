...
public class Main {
   public static void main(String[] args) {
      ...
      // This next line was moved from outside the main method to inside where it belongs
   ...
   /// Removed the String[] arg argument as it was written due to Theo's confusion on how these thigns work and had no function
